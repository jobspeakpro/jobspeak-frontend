            ...
            <main className="flex-1 w-full max-w-[1024px] mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-8">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                        ...
                        {/* For You */}
                        <div className="w-full min-w-0 rounded-xl border border-[#dce0e5] dark:border-[#2a343f] bg-white dark:bg-[#1A222C] p-6 shadow-sm hover:border-[#197fe6]/30 transition-colors overflow-hidden h-full">
