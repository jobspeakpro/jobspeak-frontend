        ...
        <div className="w-full max-w-[480px] flex flex-col gap-6">
          ...
          <div className="bg-white dark:bg-[#1a222d] rounded-2xl shadow-xl dark:shadow-slate-900/20 border border-slate-100 dark:border-slate-800 overflow-hidden">
            ...
            <div className="pt-8 px-8 pb-2 text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#111418] dark:text-white mb-3 tracking-tight">Sign in to JobSpeak Pro</h2>
            ...
            <div className="p-8 pt-6 flex flex-col gap-4">
              ...
              <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="flex justify-between text-sm font-medium text-[#111418] dark:text-slate-200" htmlFor="password">
                    Password
            ...
            <div className="bg-slate-50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-800 p-6 flex flex-col gap-3">
              <div className="flex items-center justify-between gap-4 flex-wrap">
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-[#111418] dark:text-white">New to JobSpeak Pro?</span>
                  <span className="text-xs text-slate-500 dark:text-slate-400">Create an account to save your practice across devices.</span>
                </div>
                <Link to="/signup" className="shrink-0 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-[#111418] dark:text-white hover:bg-slate-50 dark:hover:bg-slate-700 text-sm font-semibold h-10 px-4 transition-colors flex items-center justify-center">
                  Create Account
                </Link>
              </div>
            </div>
      ...
      {toast === "success" && (
        <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-[100] bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800 rounded-lg px-4 py-3 shadow-lg max-w-md">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-emerald-900 dark:text-emerald-200">Welcome back</p>
            </div>
            <button
              onClick={() => setToast(null)}
